  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (response.status === 200) {
        reset();
        setIsMessage(`Thank you ${data.name}, your message is sent!`);
        setTimeout(() => {
          setIsMessage("");
        }, 3000);
      }
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center sm:mt-10 px-0 lg:px-20 2xl:px-32">
            ...
            <div className="w-full">
              <form
                ...
                className="px-0 lg:px-8 pt-6 pb-8 mb-4"
              >
                <div className="flex flex-col lg:flex-row lg:justify-between gap-0 lg:gap-4">
                  <div className="mb-4 w-full">
                    ...
                    />
                    {errors.name && (
                      <p className="text-orange-500 text-xs mt-1 font-semibold italic">
                        {errors.name.message}
                      </p>
                    )}
                  </div>
